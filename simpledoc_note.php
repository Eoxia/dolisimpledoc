...
$langs->loadLangs(array("simpledocmodule@simpledocmodule", "companies"));
...
if ($id > 0 || !empty($ref)) {
	$upload_dir = $conf->simpledocmodule->multidir_output[$object->entity]."/".$object->id;
}

$permissionnote = $user->rights->simpledocmodule->simpledoc->write; // Used by the include of actions_setnotes.inc.php
$permissiontoadd = $user->rights->simpledocmodule->simpledoc->write; // Used by the include of actions_addupdatedelete.inc.php
