 ...
 */
class mod_simpledoc_advanced extends ModeleNumRefSimpleDoc
{
	/**
	...
	public function info()
	{
		...
		$tooltip .= $langs->trans("GenericMaskCodes4a", $langs->transnoentities("SimpleDoc"), $langs->transnoentities("SimpleDoc"));
