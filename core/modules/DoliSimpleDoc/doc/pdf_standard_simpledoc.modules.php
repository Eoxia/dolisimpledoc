...
/**
 *	Class to manage PDF template standard_simpledoc
 */
class pdf_standard_simpledoc extends ModelePDFSimpleDoc
{
	/**
	...
	public function write_file($object, $outputlangs, $srctemplatepath = '', $hidedetails = 0, $hidedesc = 0, $hideref = 0)
	{
		...
		/*
		if (!empty($conf->global->MAIN_GENERATE_SIMPLEDOC_WITH_PICTURE))
		{
