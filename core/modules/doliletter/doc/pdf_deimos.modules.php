...
//				}
				...
				if ($object->status == 6) {
					$pdf->writeHTMLCell(190, 3, $this->posxdesc - 1, $tab_top - 1, $langs->trans('AcknowledgementReceiptTextLetter', $object->ref, dol_print_date($receiver->signature_date)), 0, 1);
				} elseif ($object->status == 5) {
					$pdf->writeHTMLCell(190, 3, $this->posxdesc - 1, $tab_top - 1, $langs->trans('AcknowledgementReceiptTextMail', $receiver->firstname . ' ' . $receiver->lastname, preg_replace('/AR_/', '', $filename), $receiver->ip), 0, 1);
				}
