...
$contextpage = GETPOST('contextpage', 'aZ') ? GETPOST('contextpage', 'aZ') : 'simpledoclist'; // To manage different context of search
...
$topicmail = "SendSimpleDocRef";
$modelmail = "simpledoc";
$objecttmp = new SimpleDoc($db);
