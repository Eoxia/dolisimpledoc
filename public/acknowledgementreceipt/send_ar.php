...
$langs->loadLangs(array('companies', 'other', 'mails', 'ticket', 'doliletter@doliletter'));
...
if ($action == 'addSignature') {
	...
	$signatory->setSignatory($object->id,'user', array($user->id), 'E_RECEIVER');
...
$arrayofjs  = array("/doliletter/js/doliletter.js.php");
$arrayofcss = array('/opensurvey/css/style.css', '/ticket/css/styles.css.php', "/doliletter/css/doliletter.css");

llxHeader($langs->trans("CreateTicket"), "", '', '',0, 0, $arrayofjs, $arrayofcss);
...
<div class="wpeo-form tableforinputfields">
	<div class="wpeo-gridlayout grid-2">
		<div class="form-element">
			<span class="form-label"><?php print $langs->trans('ReceivedOn'); ?></span>
			<label class="form-field-container">
				<input type="date" value="<?php echo dol_print_date(dol_now())?>" name="reception_date" id="reception_date">
			</label>
		</div>
		<div class="form-element">
			<span class="form-label"><?php print $langs->trans("Firstname"); ?></span>
			<label class="form-field-container">
				<input name="firstname" id="firstname">
			</label>
		</div>
		<div class="form-element">
			<span class="form-label"><?php print $langs->trans("Lastname"); ?></span>
			<label class="form-field-container">
				<input name="lastname" id="lastname">
			</label>
		</div>
		<div class="form-element">
			<span class="form-label"><?php print $langs->trans("Signature"); ?></span>
			<label class="form-field-container">
				<textarea name="message" id="message"></textarea>
			</label>
		</div>
		<div class="form-element signature">
			<div class="wpeo-gridlayout grid-2">
