...
ALTER TABLE llx_doliletter_letter_sending ADD CONSTRAINT llx_doliletter_letter_sending_fk_envelope FOREIGN KEY (fk_envelope) REFERENCES llx_doliletter_envelope(rowid);
