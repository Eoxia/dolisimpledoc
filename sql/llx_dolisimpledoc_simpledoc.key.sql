...
--ALTER TABLE llx_dolisimpledoc_simpledoc ADD CONSTRAINT llx_dolisimpledoc_simpledoc_fk_field FOREIGN KEY (fk_field) REFERENCES llx_dolisimpledoc_myotherobject(rowid);
