...
/**
 *  \file       simpledoc_contact.php
 *  \ingroup    simpledocmodule
 *  \brief      Tab for contacts linked to SimpleDoc
 */
...
$hookmanager->initHooks(array('simpledoccontact', 'globalcard')); // Note that conf->hooks_modules contains array
...
$permission = $user->rights->simpledocmodule->simpledoc->write;
...
$title = $langs->trans('SimpleDoc')." - ".$langs->trans('ContactsAddresses');
$help_url = '';
